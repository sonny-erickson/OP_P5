...
<?php ob_start(); ?>
  ...
  <div class="container-fluid" id='home'>
      ...
      <p>Après vous êtes inscrit : <a class='btn btn-success btn-sm mx-3' href="index.php?page=inscription">Inscription</a>et/ou connecté:  <a class='btn btn-warning btn-sm mx-3' href="index.php?page=connection">Connection</a></p>
