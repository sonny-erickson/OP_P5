...
<?php ob_start(); ?>
  ...
  <div class="container-fluid" id='home'>
      ...
      <p>Après vous êtes inscrit : <a class='btn btn-success btn-lg mx-3' href="index.php?page=inscription">Inscription</a>et/ou connecté:  <a class='btn btn-success btn-lg mx-3' href="index.php?page=connection">Connection</a></p>
      <p>Après avoir selectionné un jeu,vous pouvez l'ajouter dans votre liste personnalisée</p>
      <p>Comme dans l'exemple suivant: </p>
      <div class="picture01 border border-info">
      ...
      <div class="picture02 border border-info">
      <img class="rounded mb-3" src="assets/02.png" alt="exemple">
      </div>
  </div>
