			...
			<div class="table-responsive">
				...
				<tbody class="table-light">
					<tr>
						...
						<td></td>
						<td><?= htmlspecialchars($post['developers']); ?></td>
						...
						<td><a class="btn btn-info btn-sm mt-1"  style="width: 75px;height: 31px;font-size: 13px;" href="index.php?page=details&&amp;slug=<?= $post['slug']?>" >Infos</a></td>
